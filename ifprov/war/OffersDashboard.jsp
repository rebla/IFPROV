			...
			<!-- Banner -->
				<section id="banner">
					<div class="content menu-ancho text-center">
						<c:if test="${fn:length(offers) == 0}">No has publicado ninguna oferta todavía...</c:if>
					<c:forEach items="${offers}" var="offer">
						<div class="col-md-3 height offer">
							...
							<span>
								...
								<a class="btn btn-danger btn-round btn-border-w" href="<c:url value="/eliminaoferta?id=${offer.id}" />">Eliminar</a>
							</span>
						</div>
					</c:forEach>		
					</div>
